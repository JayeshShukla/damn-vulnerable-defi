...
describe("[Challenge] Puppet v2", function () {
  ...
  it("Execution", async function () {
    ...
    // req now:  29 496494833197321980 -> 29 ETH
    // havenow : 29 900445651520066078 -> 29 ETH
    await weth.connect(player).deposit({ value: 29500445651520066078n });
    await weth
      .connect(player)
      .approve(lendingPool.address, await weth.balanceOf(player.address));
