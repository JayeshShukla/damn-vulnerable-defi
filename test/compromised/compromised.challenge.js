...
describe("Compromised challenge", function () {
  ...
  const sources = [
    ...
    "0xe92401A4d3af5E446d93D11EEc806b1462b39D15", // 1
    "0x81A5D6E50C214044bE44cA0CB057fe119097850c", // 2
  ];

  const EXCHANGE_INITIAL_ETH_BALANCE = 999n * 10n ** 18n; // 999 ETH
  const INITIAL_NFT_PRICE = 999n * 10n ** 18n; // 999 ETH
  const PLAYER_INITIAL_ETH_BALANCE = 1n * 10n ** 17n; // 0.1 ETH
  const TRUSTED_SOURCE_INITIAL_ETH_BALANCE = 2n * 10n ** 18n; // 2 ETH
